...
const Detail = () => {
  ...
  const { startLoading, finishLoading } = useContext(MyLayout.LayoutContext);
  ...
  return (
    <Page header={<PokemonNavbar />}>
      <div >
        ...
        <div className="boxPadding" style={{ background: "#eeeeee" }}>
        <div
          className="row justify-content-center align-items-center bx-content"
          style={{ height: "500px" }}
        >
          <div style={{ marginBottom: "10px" }} className="col-lg-4">
            <PokemonSelect />
          </div>
